...
@app.on_message(
    command(["مميزات","مميزات نور"])
 )
async def mmmezat(client, message):
        await message.reply_text(f"""**مرحبآ بك عزيزي » {message.from_user.mention}**في قسم مميزات سورس نور ميوزك\n
⩹━★⊷⌯⌞ 𝘴𝘰𝘶𝘳𝘤𝘦 𝘯𝘰𝘰� ⌝⌯⊶★━⩺

★قايمه مميزات سورس نور 
            ...
            [
                [
                    InlineKeyboardButton(
                        "★⌞ 𝘴𝘰𝘶𝘳𝘤𝘦 𝘯𝘰𝘰� ⌝⚡", url=f"https://t.me/NO_VP8"),                        
                 ],[
                InlineKeyboardButton(
