...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("NO_VP0")
                await self.one.join_chat("NO_VP8")
            except:
                pass
            assistants.append(1)
            ...
            try:
                await self.one.send_message(
                    config.LOG_GROUP_ID, f" تم تنصيب المساعد علي سورس نور ."
                )
            except:
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("NO_VP0")
                await self.two.join_chat("NO_VP8")
            except:
                pass
            assistants.append(2)
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("NO_VP0")
                await self.three.join_chat("NO_VP8")
            except:
                pass
            assistants.append(3)
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("NO_VP0")
                await self.four.join_chat("NO_VP8")
            except:
                pass
            assistants.append(4)
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("NO_VP0")
                await self.five.join_chat("NO_VP8")
            except:
                pass
            assistants.append(5)
